...
```jsonc
{ "command": "cmd", "args": ["/c", "npx", "-y", "@tesseron/mcp@2.10.2"] }
```
...
```jsonc
{
  ...
  "mcp": {
    "tesseron": {
      "type": "local",
      "command": ["npx", "-y", "@tesseron/mcp@2.10.2"],
      "enabled": true
    },
    "tesseron-docs": {
      "type": "local",
      "command": ["npx", "-y", "@tesseron/docs-mcp@2.10.2"],
      "enabled": true
    }
  }
}
...
```jsonc
{ "command": "node", "args": ["/abs/path/to/tesseron/gateway/dist/index.cjs"] }
```

---
"@tesseron/mcp": major
"@tesseron/server": major
"@tesseron/web": major
"@tesseron/react": major
"@tesseron/svelte": major
"@tesseron/vue": major
"@tesseron/vite": major
"@tesseron/core": major
---

Reversed connection architecture. The gateway is now a pure WebSocket client; apps host their own endpoints and announce themselves via `~/.tesseron/tabs/<tabId>.json`. One discovery mechanism for every runtime, no fixed ports.

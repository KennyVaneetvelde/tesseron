---
title: SDK overview
description: What a Tesseron SDK has to expose across TypeScript, Rust, Python, and C++.
related:
  - sdk/rust/index
  - sdk/python/index
  - sdk/cpp/index
...
Today we ship eight TypeScript packages, plus Rust, Python, and C++ SDKs in the hub repository. The surface they expose - the **SDK contract** - is the portable part. The Rust, Python, and C++ implementations are unpublished for now and live under `sdks/rust/`, `sdks/python/`, and `sdks/cpp/`.
...
<CardGrid>
  <LinkCard title="Python SDK" href="/sdk/python/"
    description="asyncio and Pydantic v2, the full host surface, passing conformance. Not on PyPI yet." />
  <LinkCard title="Rust SDK" href="/sdk/rust/"
    description="Tokio and WebSocket host with typed actions, resources, and the full context API. Not on crates.io yet." />
  <LinkCard title="C++ SDK" href="/sdk/cpp/"
    description="C++20 and Boost.Asio host with actions, resources, and the full context API. Not packaged yet." />

...
Today we ship eight TypeScript packages, plus Rust and Python SDKs in the hub repository. The surface they expose - the **SDK contract** - is the portable part. The Rust and Python implementations are unpublished for now and live under `sdks/rust/` and `sdks/python/`.

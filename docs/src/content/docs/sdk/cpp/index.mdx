...
From the repository root, configure with `-DTESSERON_BUILD_EXAMPLES=ON`, then build `tesseron-example-todo` and `tesseron-example-prompts` under `sdks/cpp/build/examples/`.

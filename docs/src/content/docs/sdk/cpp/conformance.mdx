...
**Every fixture passes except the ten it declares it cannot serve**, on Linux with clang and on Windows with MSVC. At the corpus this was last run against, that is 27 passed, 10 skipped, 0 failed.
